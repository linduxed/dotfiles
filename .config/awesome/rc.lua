...
-- {{{ Wibox
-- Awesome logo
logo = wibox.widget.imagebox()
logo:set_image(beautiful.awesome_icon)

-- Create a textclock widget
datetime = awful.widget.textclock( "" .. colbblu .. "%a %b %d" .. coldef .. " " .. colcya .. "%H:%M:%S" .. coldef, 1)

space = wibox.widget.textbox()
space:set_text(" ")

separator = wibox.widget.textbox()
separator:set_markup("" .. colwhi .. "|" .. coldef)
