...
" :help snipMate-remap).
ino <silent> <c-h> <c-r>=TriggerSnippet()<cr>
snor <silent> <c-h> <esc>i<right><c-r>=TriggerSnippet()<cr>
ino <silent> <c-j> <c-r>=BackwardsSnippet()<cr>
snor <silent> <c-j> <esc>i<right><c-r>=BackwardsSnippet()<cr>
